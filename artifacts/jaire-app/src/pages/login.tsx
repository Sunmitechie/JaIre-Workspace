...
export default function Login() {
  ...
  const finishLogin = async (
    ...
    // Derive MPC wallet using the provider JWT.
    // The MPC sidecar accepts Web3Auth JWTs, Google JWTs, and falls back
    // to claim-based decoding for devnet — no extra auth call needed here.
      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-6" style={{ animation: "fadeIn 0.6s ease-out" }}>
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            Premium coworking for the Lagos tech scene.<br />Sign in to meet Baire, your space concierge.
          </p>
        </div>
